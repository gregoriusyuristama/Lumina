...
class PenumbralEclipse2: SKScene{
    ...
    var moon = SKSpriteNode(imageNamed: "moon_happy")
    ...
    var starFormation = SKSpriteNode(imageNamed: "star_penumbral")
    var highFuel = SKSpriteNode(imageNamed: "high_fuel")
    ...
    override func didMove(to view: SKView) {
        ...
        text.text = "With the bountiful harvest exceeding his usual standards, Mr. Moon was happy. His galaxy creature pets were equally pleased to have more food than ever before."
        ...
        learnText.text = "Learn About Penumbral Eclipse"
        ...
        if nextButton.contains(touchLocation) {
            if storyIdx == 0 {
                self.run(SKAction.sequence([
                    ...
                    SKAction.wait(forDuration: 1),
                    SKAction.run {
                        self.text.text = "Mr. Moon's excessive joy led to him overeating, and he looked unusually fresh..."
                ...
                self.run(SKAction.sequence([
                    ...
                    SKAction.wait(forDuration: 1),
                    SKAction.run {
                        self.text.text = "His body became round and devoid of blood or any red color. This is how the \"Penumbral Eclipse\" came to be."
                        self.text.run(SKAction.fadeIn(withDuration: 1))
                    },
                    SKAction.wait(forDuration: 1),
                    SKAction.run {
